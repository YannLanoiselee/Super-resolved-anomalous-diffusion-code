function [x_beta,x_rice] = find_bounds_true_alpha_D_beta_Rice_v1(beta_mean,beta_std,beta_min,beta_max,mu,sigma,n_bin_beta,n_bin_rice)
...
x_rice=linspace(max([min(mu-5*sigma),0]),max(mu+5*sigma),n_bin_rice);
end