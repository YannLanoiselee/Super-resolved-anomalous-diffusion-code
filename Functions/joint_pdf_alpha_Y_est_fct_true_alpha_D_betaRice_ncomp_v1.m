function [mat_Y_alpha_est,x_alpha_true_edges,x_D_true_edges] =joint_pdf_alpha_Y_est_fct_true_alpha_D_betaRice_ncomp_v1(x_Y_est,x_alpha_est,n_bin_true,alpha_mean,alpha_std,alpha_min,alpha_max,D_mulognorm,D_stdlognorm,rho,p,X_alpha_stat_scan)

% x_alpha_true and x D true are precalculated
[x_alpha_true_edges,x_D_true_edges] = find_bounds_true_alpha_D_beta_Rice_v1(alpha_mean,alpha_std,alpha_min,alpha_max,D_mulognorm,D_stdlognorm,n_bin_true,n_bin_true);
...
%% joint pdf of estimated Y and alpha given that true alpha and D have a beta-Rice distribution
...
[pdf_true_alpha_D] = copula_beta_Rice_D_alpha_true_mean_var_ncomp(x_alpha_centers,x_D_true_centers,alpha_mean,alpha_std,alpha_min,alpha_max,D_mulognorm,D_stdlognorm,rho,p);
