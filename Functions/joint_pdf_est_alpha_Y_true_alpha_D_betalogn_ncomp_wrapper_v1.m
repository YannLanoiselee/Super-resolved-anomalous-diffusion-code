function [mat_Y_alpha_est] = joint_pdf_est_alpha_Y_true_alpha_D_betalogn_ncomp_wrapper_v1(x,xData,n_bin_true,X_alpha_stat_scan)
...
p=x(6:6:end);
%%
D_mulognorm=log(D_mean.^2./sqrt(D_mean.^2+D_std.^2));
D_stdlognorm=log(1+D_std.^2./D_mean.^2);
%%
...
[mat_Y_alpha_est]=joint_pdf_alpha_Y_est_fct_true_alpha_D_betalognorm_ncomp_v1(x_Y_est,x_alpha_est,n_bin_true,alpha_mean,alpha_std,alpha_min,alpha_max,D_mulognorm,D_stdlognorm,rho,p,X_alpha_stat_scan);
